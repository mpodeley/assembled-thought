...
- **El ensamblaje (el resultado nuevo):** lo mejor de todo — ni siquiera hace falta copiar ese
  ...
  el empujón también lo hace hablar. Empujá 40× más fuerte y balbucea en loops — *"dollar dollar
  dollar…"* — pero incluso ahí, forzado a elegir entre las respuestas posibles, acierta el **80%
  de las veces**. La sobredosis destruye la fluidez, no la información.)
...
**¿Querés verlo con tus propios ojos?** El [explorador interactivo](assembly.md) te deja mover
