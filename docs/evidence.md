...
[code repository](https://github.com/mpodeley/jspace-qwen) — every number regenerates from
`scripts/` there.*
...
independent observations). Full details in [the paper](paper.md).
...
| 11 | No privileged **readable subspace** | 4 readout comparisons (pass@k, form, number probe, concept plane) | spectrum-matched **random projection** reads as well as the fitted J-lens; random-plane baseline kills the "channel" | [working log, Part 1](https://mpodeley.github.io/jspace-qwen/findings/) |
...
*Full evidence trail, including the deliberate nulls: [working log](https://mpodeley.github.io/jspace-qwen/findings/). Reproduce
any cell: [How to reproduce](https://mpodeley.github.io/jspace-qwen/reproduce/).*
